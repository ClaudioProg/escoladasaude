      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-3 rounded-2xl border border-blue-200 bg-white p-4 shadow-2xl shadow-blue-900/10 dark:border-blue-800/70 dark:bg-slate-950 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
            {atualizandoAutomaticamente
              ? "A versão atual será carregada automaticamente, sem apagar seu login ou suas preferências."
              : "A atualização automática foi pausada para evitar recarregamentos repetidos. Você pode tentar novamente."}
            {buildFormatado ? (
              <>
                {" "}
