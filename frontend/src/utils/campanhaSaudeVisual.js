...
const CAMPANHAS_SAUDE_MENSAL = {
  1: {
    ...
    gradienteHero: "from-white via-slate-100 to-cyan-100",
    ...
    topbar: "from-white via-slate-100 to-cyan-100",
    topbarGlow: "from-cyan-300/35 via-white/40 to-slate-300/35",
  ...
  2: {
    ...
    gradienteHero: "from-violet-950 via-purple-800 to-fuchsia-800",
    ...
    topbar: "from-violet-700 via-purple-700 to-fuchsia-700",
    topbarGlow: "from-violet-400/35 via-purple-400/30 to-fuchsia-400/35",
  ...
  3: {
    ...
    textoContraste: "claro",
    gradienteHero: "from-purple-800 via-fuchsia-700 to-pink-700",
    ...
    topbar: "from-purple-600 via-fuchsia-600 to-pink-600",
    topbarGlow: "from-purple-300/35 via-fuchsia-300/30 to-pink-300/35",
  ...
  4: {
    ...
    textoContraste: "claro",
    gradienteHero: "from-emerald-800 via-green-700 to-teal-700",
    ...
    topbar: "from-emerald-600 via-green-600 to-teal-600",
    topbarGlow: "from-emerald-300/35 via-green-300/30 to-teal-300/35",
  ...
  5: {
    ...
    textoContraste: "escuro",
    gradienteHero: "from-amber-200 via-yellow-300 to-orange-300",
    ...
    topbar: "from-amber-300 via-yellow-300 to-orange-300",
    topbarGlow: "from-amber-300/45 via-yellow-300/40 to-orange-300/45",
  ...
  6: {
    ...
    textoContraste: "escuro",
    gradienteHero: "from-red-800 via-orange-700 to-amber-700",
    overlayHero: "bg-slate-950/16",
    textoHero: "text-white",
    textoSuaveHero: "text-white/90",
    bordaHero: "border-white/10",
    ...
    topbar: "from-red-600 via-orange-600 to-amber-600",
    topbarGlow: "from-red-300/35 via-orange-300/30 to-amber-300/35",
  ...
  7: {
    ...
    textoContraste: "escuro",
    gradienteHero: "from-lime-200 via-yellow-300 to-emerald-300",
    overlayHero: "bg-white/8",
    textoHero: "text-slate-950",
    textoSuaveHero: "text-slate-800",
    ...
    topbar: "from-lime-300 via-yellow-300 to-emerald-300",
    topbarGlow: "from-lime-300/45 via-yellow-300/40 to-emerald-300/45",
  ...
  8: {
    ...
    textoContraste: "escuro",
    gradienteHero: "from-amber-300 via-yellow-400 to-orange-400",
    overlayHero: "bg-white/8",
    textoHero: "text-slate-950",
    textoSuaveHero: "text-slate-800",
    ...
    topbar: "from-amber-400 via-yellow-400 to-orange-400",
    topbarGlow: "from-amber-300/45 via-yellow-300/40 to-orange-300/45",
    foco: "focus-visible:ring-amber-500",
  },
  ...
  9: {
    ...
    textoContraste: "claro",
    gradienteHero: "from-red-950 via-red-800 to-rose-800",
    overlayHero: "bg-slate-950/16",
    textoHero: "text-white",
    textoSuaveHero: "text-white/90",
    bordaHero: "border-white/10",
    ...
    topbarGlow: "from-red-300/35 via-rose-300/30 to-red-300/35",
  ...
  10: {
    ...
    textoContraste: "claro",
    gradienteHero: "from-rose-800 via-pink-700 to-fuchsia-700",
    overlayHero: "bg-slate-950/14",
    textoHero: "text-white",
    textoSuaveHero: "text-white/90",
    bordaHero: "border-white/10",
    ...
    topbar: "from-rose-600 via-pink-600 to-fuchsia-600",
    topbarGlow: "from-rose-300/35 via-pink-300/30 to-fuchsia-300/35",
  ...
  11: {
    ...
    textoContraste: "claro",
    gradienteHero: "from-blue-900 via-indigo-800 to-purple-800",
    overlayHero: "bg-slate-950/16",
    textoHero: "text-white",
    textoSuaveHero: "text-white/90",
    bordaHero: "border-white/10",
    ...
    topbar: "from-blue-700 via-indigo-700 to-purple-700",
    topbarGlow: "from-blue-300/35 via-indigo-300/30 to-purple-300/35",
  ...
  12: {
    ...
    textoContraste: "claro",
    gradienteHero: "from-orange-800 via-amber-700 to-red-700",
    overlayHero: "bg-slate-950/14",
    textoHero: "text-white",
    textoSuaveHero: "text-white/90",
    bordaHero: "border-white/10",
    ...
    topbar: "from-orange-600 via-amber-600 to-red-600",
    topbarGlow: "from-orange-300/35 via-amber-300/30 to-red-300/35",
    foco: "focus-visible:ring-orange-500",
  },
};
...
export function getCampanhaSaudeVisual(mesReferencia) {
  ...
  return (
    CAMPANHAS_SAUDE_MENSAL[mes] || CAMPANHAS_SAUDE_MENSAL[MES_ATUAL_FALLBACK]
  );
}
